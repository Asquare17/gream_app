...
class _MyProfileState extends State<MyProfile> {
                              ...
                              builder: (context, AsyncSnapshot<QuerySnapshot> snapshot) {
                                if (snapshot.hasData && snapshot.data.documents != null) {
                                  ...
                                  return GridView.count(
                                      ...
                                      children: List.generate(listGreamits.length, (index) {
                                        return Padding(
                                          padding: const EdgeInsets.symmetric(vertical: 8.0),
                                          child: FutureBuilder<WebMetaData>(
                                              future: getWebsiteMetadata(websiteString: listGreamits[index].link),
                                              builder: (context, snapshot) {
                                                return buildPostedGreamImage(
                                                    deviceWidth: MediaQuery.of(context).size.width,
                                                    categoryTag: listGreamits[index].categoryList,
                                                    image: snapshot.hasData != null && snapshot.data != null ? snapshot.data.data.image : null,
  ...
  Widget buildPostedGreamImage({double deviceWidth, String image, String title, List<String> categoryTag}) {
    return Padding(
                ...
                Container(
                  ...
                  child: ListView.builder(
                      ...
                      itemBuilder: (BuildContext context, int index) {
                        return CustomTag(categoryTag[index], backgroundColor: Colors.white.withOpacity(0.1),);
                      }),
                ),
                Expanded(
                  child: Padding(
